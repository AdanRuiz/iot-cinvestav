        ...
        selection.each(function(data) {
            ...
            layer.renderGuideLine = function(x) {
                ...
                line.enter()
                    ...
                    .attr("x3", function(d) { return d;})
                    .attr("x4", function(d) { return d;})
                    .attr("x5", function(d) { return d;})
...
//Modificacion de codigo
           ...
           /* var series3 = data
            ...
            x2.domain(d3.extent(d3.merge(series1), function(d) { return d.x } ))
            x2.domain(d3.extent(d3.merge(series1.concat(series2)), function(d) { return d.x } ))
            //  x2.domain(d3.extent(d3.merge(series1.concat.series2.concat.series3.concat.series4.concat(series5)), function(d) { return d.x } ))
                .range([0, availableWidth]);
...
nv.models.lineWithFocusChart = function() {
    ...
    var lines = nv.models.line()
       // , lines2 = nv.models.line()
        ...
        , y3Axis = nv.models.axis()
        , x4Axis = nv.models.axis()
        , y4Axis = nv.models.axis()
        , x5xis = nv.models.axis()
        , y5xis = nv.models.axis()
        , legend = nv.models.legend()
        , brush = d3.svg.brush()
        ;
    ...
    function chart(selection) {
        ...
        y2Axis
            .scale(y3)
            .ticks( nv.utils.calcTicksY(availableHeight3/36, data) )
            .tickSize( -availableWidth, 0);
    ...
    x4Axis
        .scale(x4)
        .ticks( nv.utils.calcTicksX(availableWidth/100, data) )
        .tickSize(-availableHeight4, 0);

    g.select('.nv-context .nv-x.nv-axis')
        .attr('transform', 'translate(0,' + y4.range()[0] + ')');
    d3.transition(g.select('.nv-context .nv-x.nv-axis'))
        .call(x4Axis);

    y4Axis
        .scale(y4)
        .ticks( nv.utils.calcTicksY(availableHeight4/36, data) )
        .tickSize( -availableWidth, 0);
...
x5Axis
    .scale(x5)
    .ticks( nv.utils.calcTicksX(availableWidth/100, data) )
    .tickSize(-availableHeight5, 0);

g.select('.nv-context .nv-x.nv-axis')
    .attr('transform', 'translate(0,' + y5.range()[0] + ')');
d3.transition(g.select('.nv-context .nv-x.nv-axis'))
    .call(x5Axis);

y5Axis
    .scale(y5)
    .ticks( nv.utils.calcTicksY(availableHeight5/36, data) )
    .tickSize( -availableWidth, 0);
...
g.select('.nv-context .nv-x.nv-axis')
    .attr('transform', 'translate(0,' + y5.range()[0] + ')');
            ...
            function updateBrushBG3() {
                if (!brush.empty()) brush.extent(brushExtent);
                brushBG
                    .data([brush.empty() ? x3.domain() : brushExtent])
                    .each(function(d,i) {
                        var leftWidth = x3(d[2]) - x2.range()[2],
                            rightWidth = x2.range()[3] - x3(d[3]);
                        d3.select(this).select('.left')
                            .attr('width',  leftWidth < 0 ? 0 : leftWidth);
            ...
            function updateBrushBG4() {
                if (!brush.empty()) brush.extent(brushExtent);
                brushBG
                    .data([brush.empty() ? x4.domain() : brushExtent])
                    .each(function(d,i) {
                        var leftWidth = x4(d[3]) - x3.range()[3],
                            rightWidth = x3.range()[4] - x3(d[4]);
                        d3.select(this).select('.left')
                            .attr('width',  leftWidth < 0 ? 0 : leftWidth);
            ...
            function updateBrushBG5() {
                if (!brush.empty()) brush.extent(brushExtent);
                brushBG
                    .data([brush.empty() ? x5.domain() : brushExtent])
                    .each(function(d,i) {
                        var leftWidth = x5(d[4]) - x4.range()[4],
                            rightWidth = x4.range()[5] - x4(d[5]);
                        d3.select(this).select('.left')
                            .attr('width',  leftWidth < 0 ? 0 : leftWidth);
            ...
            function onBrush() {
                ...
                //The brush extent cannot be less than one.  If it is, don't update the line chart.
                if (Math.abs(extent[2] - extent[3]) <= 3) {
                    return;
                }
                    ...
                    data
                        ...
                        .map(function(d,i) {
                            return {
                                ...
                                area: d.area,
                                values: d.values.filter(function(d,i) {
                                    return lines.x()(d,i) >= extent[3] && lines.x()(d,i) <= extent[3];
                                })
                            }
                        })
                );
            ...
            function onBrush() {
                brushExtent = brush.empty() ? null : brush.extent();
                var extent = brush.empty() ? x4.domain() : brush.extent();

                //The brush extent cannot be less than one.  If it is, don't update the line chart.
                if (Math.abs(extent[4] - extent[5]) <= 5) {
                    return;
                }
                    ...
                    data
                        ...
                        .map(function(d,i) {
                            return {
                                ...
                                area: d.area,
                                values: d.values.filter(function(d,i) {
                                    return lines.x()(d,i) >= extent[5] && lines.x()(d,i) <= extent[5];
                                })
                            }
                        })
                );
            ...
            function onBrush() {
                brushExtent = brush.empty() ? null : brush.extent();
                var extent = brush.empty() ? x5.domain() : brush.extent();

                //The brush extent cannot be less than one.  If it is, don't update the line chart.
                if (Math.abs(extent[5] - extent[7]) <= 6) {
                    return;
                }
                    ...
                    data
                        ...
                        .map(function(d,i) {
                            return {
                                ...
                                area: d.area,
                                values: d.values.filter(function(d,i) {
                                    return lines.x()(d,i) >= extent[6] && lines.x()(d,i) <= extent[6];
                                })
                            }
                        })
                );
    ...
    chart._options = Object.create({}, {
        ...
        interpolate: {get: function(){return lines.interpolate();}, set: function(_){
            ...
            lines3.interpolate(_);
            lines4.interpolate(_);
            lines5.interpolate(_);
        }},
        ...
        yTickFormat: {get: function(){return yAxis.yTickFormat();}, set: function(_){
            ...
            y3Axis.yTickFormat(_);
            y4Axis.yTickFormat(_);
            y5Axis.yTickFormat(_);
        }},
        duration:    {get: function(){return transitionDuration;}, set: function(_){
            transitionDuration=_;
            yAxis.duration(transitionDuration);
